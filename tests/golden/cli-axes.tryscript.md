...
{"view": "list", "bound": null, "files": [{"path": "a[JSON_SEP].venv", "kind": "dir", "bytes": 0, "allocated": [ALLOCATED], "mtime_ns": [MTIME_NS], "files": 0, "dirs": 0, "complete": false, "age_ns": null, "ignored": false}, {"path": "d[JSON_SEP].venv", "kind": "dir", "bytes": 0, "allocated": [ALLOCATED], "mtime_ns": [MTIME_NS], "files": 0, "dirs": 0, "complete": false, "age_ns": null, "ignored": false}, {"path": "empty[JSON_SEP].venv", "kind": "dir", "bytes": 0, "allocated": [ALLOCATED], "mtime_ns": [MTIME_NS], "files": 0, "dirs": 0, "complete": false, "age_ns": null, "ignored": false}]}
? 0
```
