...
updated_at: 2026-09-01T16:55:03.837Z
...
2026-09-01 the detached builder receives complete sibling groups and no longer needs a per-entry public observation. It still materializes the ordinary per-directory BTreeMap layout, so sorted arena slices remain open as part of the composite retained representation. Historical construction parity is reached, while default-tree teardown/RSS attribution must determine whether this representation change clears the 3% gate.
