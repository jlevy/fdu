...
updated_at: 2026-08-25T15:25:12.298Z
closed_at: null
close_reason: null
resolution: null
duplicate_of: null
...
Reopened: Reopened against PR 47 exact head 353d48f6c795b72e1c4c94ed8f95b8e08b815c9b. watch::admitted now correctly prunes hidden rows, but it also converts a live .gitignore upsert into Remove before Session::rebind_tags_for sees applied deltas. Because pruned control files have no indexed row, the remove is ineffective and no delta is retained; edits, creates, and deletes of hidden governing files therefore never rebind or retag. Preserve a bounded control-file signal without retaining the hidden row or walking the tree, and test create/edit/delete under the reference hidden-prune plus promoted-gitignore configuration.
