...
updated_at: 2026-08-11T04:39:35.192Z
---
...
Deferred at the 100k+ scale point for disk, not for design: the data volume is at 100% (2.1 GiB free), and a 500k-1M corpus needs more headroom than that. The knee experiment (research H36, --repeat 2 discrimination at 100k/500k/1M recording per-iteration component, minor_faults, blocked_ns, kern.maxvnodes) is specified and ready to run once space exists; it directs whether the 500k+ tail gets the parallel sweep or index work. Exploratory curve so far: 72 ms / 725 ms / 8.2 s / 62.9 s at 10k/100k/500k/1M.
