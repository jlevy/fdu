...
updated_at: 2026-09-14T15:33:19.069Z
closed_at: 2026-09-14T15:33:19.068Z
close_reason: "c609423: workers record their own exit (OpenedState.failures) and wake the journal; changes() returns OpenedWorkerPanicked after delivering retained commits; close reports the earliest recorded failure with a panic outranking the poison trace it caused; DirectoryComplete carries the canonical path. Decision: PY-1's catch in production spawn_worker taken, resume_unwind after recording. Not covered: a client-thread panic that poisons the index lock. Four tests, gate-driven ones run 8x."
resolution: null
duplicate_of: null
---
