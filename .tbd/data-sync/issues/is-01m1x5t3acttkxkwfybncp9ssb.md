...
updated_at: 2026-09-07T06:01:00.213Z
---
...
Red-green: cross-revision capture rejected valid control/candidate version identities; new per-artifact source mappings pass capture and measurement verification and reject missing attribution, stale and dirty control sources. A second red test caught rustc provenance resolved in the caller cwd; it now resolves in each source checkout. 224 realtree tests pass, Ruff baseline checks and formatting pass. Integrated make check running. No acceptance criteria or timing evidence changed.
