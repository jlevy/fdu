...
updated_at: 2026-09-16T05:51:23.999Z
closed_at: 2026-09-16T05:51:23.998Z
close_reason: "c63988f (PR #65): Change carries ignored; a Reclassified effect that moves an entry across an ignored-state selection streams the remove or the upsert that maintains it, read once per batch under the lock the session already takes. Fixed in the engine, so the Python watch iterator gets it too. Pinned by two event-gated integration tests in crates/fdu/tests/watch_controls.rs, one per direction, run 12 times; the fdu.stream/1 record test gains the field."
resolution: null
duplicate_of: null
---
