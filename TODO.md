...
| `fdu-snej` — implement the opened-root inventory engine rewrite | 13 | Phase 1 is complete. Phase 2 has landed ownership, discovery, reads, and changes; bounded multi-path refresh is in progress, followed by observation, session proof, Python, and the joint MetaBrowser integration. Work remains phase-gated on draft PR #48. | [opened-root inventory](docs/project/specs/active/plan-2026-08-25-fdu-opened-root-inventory-engine.md) |
...
| [opened-root inventory engine rewrite](docs/project/specs/active/plan-2026-08-25-fdu-opened-root-inventory-engine.md) | Active; Phase 2 in progress | Epic `fdu-snej`: Phase 1 is complete. Refresh is the current Phase 2 checkpoint, with observation, session proof, Python, MetaBrowser adoption, and composed acceptance still open. |
