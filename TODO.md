...
| `fdu-u7vo` — fdu for interactive clients: the metabrowser contract | 15 | Shared reads during a write (a measured drop-in blocker), partitioned (gitignore/hidden) tallies, a customizable roll-up taxonomy with a browsing group level, the embedder watch contract, the session integration shape, and the adoption proof. | [interactive client integration](docs/project/specs/active/plan-2026-08-23-fdu-interactive-client-integration.md) |
