...
| `fdu-snej` — implement the opened-root inventory engine rewrite | 11 | Phase 1 is complete. Phase 2 has landed ownership, discovery, reads, changes, refresh, and no-gap observation through `e5e27eb`, with all 19 clean-runner checks passing. The five-session proof is in progress, followed by Python and the joint MetaBrowser integration. Work remains phase-gated on draft PR #48. | [opened-root inventory](docs/project/specs/active/plan-2026-08-25-fdu-opened-root-inventory-engine.md) |
