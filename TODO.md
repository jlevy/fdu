...
| `fdu-snej` — implement the opened-root inventory engine rewrite | — | One authoritative opened root, exact commits, bounded coherent reads and changes, and the joint MetaBrowser provider integration. Work is phase-gated on draft PR #48. | [opened-root inventory](docs/project/specs/active/plan-2026-08-25-fdu-opened-root-inventory-engine.md) |
...
| [opened-root inventory engine rewrite](docs/project/specs/active/plan-2026-08-25-fdu-opened-root-inventory-engine.md) | Draft, in progress | Epic `fdu-snej`: four phase-gated implementation stages on draft PR #48, with MetaBrowser PR #74 as the coordinated client branch. |
