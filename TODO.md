...
| `fdu-u7vo` — fdu for interactive clients: the metabrowser contract | 11 | Partitioned (gitignore/hidden) tallies, the embedder watch contract (dirty sets, scoped refresh, poll backend, asyncio), the session integration shape, and the adoption proof. | [interactive client integration](docs/project/specs/active/plan-2026-08-23-fdu-interactive-client-integration.md) |
...
| [interactive client integration](docs/project/specs/active/plan-2026-08-23-fdu-interactive-client-integration.md) | Draft | Epic `fdu-u7vo`: the metabrowser contract — partitioned tallies, the embedder watch contract, the session integration shape, and the adoption proof. Consumes the progressive-results session rather than redesigning it. |
