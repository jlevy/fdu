...
pub use crate::index::{
    ...
    EngineState, EntryId, EntryPage, EntryPageRequest, EntryRow, ExtRemainder, ExtTally, Index,
    IndexHandle, ProjectionWork, ReadBundle, ReadRequest, ReportRequest, RollUp, RollUpScalars,
    Since, Work,
};
