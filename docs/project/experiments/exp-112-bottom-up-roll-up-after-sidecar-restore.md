...
Control wall p95/median is 1.51× from host spikes (pairs at 1.94 s and 2.69 s).
Candidate wall p95/median is 1.03×. User CPU does not follow those spikes: −8.23%
[−11.11%, −7.73%].
