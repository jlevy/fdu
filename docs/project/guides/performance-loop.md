...
| H146 | After H140, a Linux first-run `default-tree-first` leftover names whether snapshot encode/write/render is a skippable ≥3% cut. H136 analog. Not H100. Not a snapshot load on `fdu PATH`. | Determination: named leftover is or is not a new skippable ≥3% cut | **Queued** on [Linux performance iteration](../specs/active/plan-2026-09-20-linux-performance-iteration.md). |
