...
| H144 | After the landed H125+H129+H131+H133 cache-hit stack, a Linux `content-cache-hit` leftover still has a userspace stage ≥3% that Darwin H134 did not name. Not a retry of those accepts. | Determination: named leftover is or is not a new ≥3% userspace cut on reconstructible `linux-v6.12` | **Queued** on [Linux performance iteration](../specs/active/plan-2026-09-20-linux-performance-iteration.md). |
