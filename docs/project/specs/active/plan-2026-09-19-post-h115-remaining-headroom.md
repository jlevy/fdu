...
1. **H134** (`fdu-03pr`). **Confirmed** (exp-133). Snapshot `path_of` gone (0 of
   ...
   already-rejected stages.
   No engine patch. Quiet this tick 28.07%; pair 29.36%. **H133** (`fdu-7m91`).
...
skip), H134 confirmed (exp-133; snapshot `path_of` gone; no new cut), H107 skipped
...
Exact oracles and content digest stay as for exp-108–133. H123 kept one-shot
...
- exp-107 through exp-133; H115 engine at `7798fdc1`; H120 streaming restore; H125
...
- Beads: overnight epic `fdu-e9ow` (closed); remaining-queue epic `fdu-8ya1`; H121
  ...
  `fdu-1dxc`; H132 `fdu-8z5i`; H133 `fdu-7m91`; H134 `fdu-03pr`; H113 quiet `fdu-rfr6`
