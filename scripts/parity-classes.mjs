...
const KNOBS =
  /--gitignore-budget|--exclude-ignored|--only-ignored|--no-gitignore|--scan-depth|--one-filesystem|--modified-since|--include|--depth|ignored=exclude|ignored=only|control_budget|read_controls|max_depth|one_filesystem|modified_since|include|depth/g;
